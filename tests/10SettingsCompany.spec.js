...
test.describe('Company', () => {
    ...
    test("TC_10_43_01 | Verify business user can fill company's form", async ({
        ...
        await step('Verify the toast "Company information successfully saved" appears', async () =>{
        ...
        await step('Verify the entered information is displayed correctly after saving', async () =>{
