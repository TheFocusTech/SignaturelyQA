...
test.describe('createDocument', ()=> {
    ...
    test ('Sign and Send for signature', async({page}) => {
        ...
        //====Assigned To
        await page.locator('.uiSelect__select').click();
       ...
       // await page.getByText('Final Step').waitFor();
        ...
        await expect (page.locator('.documents__documentStatus--awaiting').first()).toHaveText('awaiting');
        //getByText('Document for signawaitingJun').first()

        // await page.locator('.documents__optionsDropdownTrigger-text').nth(1).click()
        // await page.getByRole('button', {name:'Delete'}).click()
        // await page.getByRole('button', {name: 'Yes, Delete'}).click();
        // await page.waitForSelector('div[type="success"]');
        // await page.locator('div[type="success"]').click()
        // await page.locator('.dropDownUser__trigger-name').first().click()
        // await page.locator('.dropDownUser__item--fill').nth(1).click();
    })
})