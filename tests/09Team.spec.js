...
test.describe('Team', () => {
  ...
  test('TC_09_39_01 | Verify that Business User can upgrade a "User" team member to "Admin"', async ({
    ...
    await link("https://app.qase.io/case/SIGN-39",
      "Qase: SIGN-45");
    await link("https://docs.google.com/document/d/1Qce7tKWOwVYtPxgQv_8ae-HUkbAgeOFph0lB_eziY_k/edit#bookmark=id.mhofpy3obgpn",
      "ATC_09_39_01");
    await epic('Team');
