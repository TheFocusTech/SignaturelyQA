...
test.describe('Registration', () => {
    test('TC_01_01_01 | Verify successful registration of Trial user.', async ({
        ...
        await description('To verify Trial user can successfully register.');
        ...
        await step('Verify Billing plan description is Business Monthly Plan.', async () => {
    ...
    test('TC_01_02_01 | Verify successful registration of Free user.', async ({
        ...
        await description('To verify Free user can successfully register.');
        await tag('Free user');
        await severity(Severity.BLOCKER);
        ...
        await step('Verify Billing plan description is Free.', async () => {
    ...
    SUBSCRIPTIONS.forEach((subscription) => {
        test(`TC_01_03_01 | Verify user can register as a Personal user with ${subscription} subscription.`, async ({
            ...
            const newUserData = await generateNewUserData();
            await step('Navigate to Personal user registration page.', async () => {
                await page.goto(URL_END_POINTS.signUpPersonalEndPoint);
            });
            await step('Verify Personal user registration page title.', async () => {
