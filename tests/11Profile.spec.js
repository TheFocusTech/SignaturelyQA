...
test.describe('Profile', () => {
    ...
    test('TC_11_45_01 | Verify that User can change password', async ({
        ...
        await link("https://docs.google.com/document/d/1Qce7tKWOwVYtPxgQv_8ae-HUkbAgeOFph0lB_eziY_k/edit#heading=h.ei34zdu9ql4d", "ATC_11_45_01");
        await link("https://app.qase.io/case/SIGN-45", "Qase: SIGN-45");
